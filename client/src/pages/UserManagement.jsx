...
const UserManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      if (res.data.success) {
        const finalUserList = res.data.users
          ? res.data.users
          : res.data.data || [];
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm mt-0.5 font-medium">
              Manage and monitor registered farmer accounts across regions.
            </p>
          </div>
        </div>
            ...
            <tbody className="text-sm divide-y divide-slate-100 text-slate-700 font-medium">
              {loading ? (
                <tr>
                  ...
                  >
                    Querying users data table matrix lines...
                  </td>
                </tr>
                ...
                <tr>
                  <td
                    ...
                    className="text-center py-12 text-slate-400 italic"
                  >
                    No matching user accounts matched this search query
                    criteria.
                  </td>
                </tr>
              ) : (
